...
pdf(file=paste0("/Users/miyang/Documents/RWTH_Aachen/HELA/PLOT/combinatorial_correlation/correlation_boxplot.pdf"), height=10, width=14, compress=TRUE)
nice_boxplot_list(L, title="Combinatorial correlation")
dev.off()

pdf(file=paste0("/Users/miyang/Documents/RWTH_Aachen/HELA/PLOT/combinatorial_correlation/correlation_boxplot_Top1000_proteins.pdf"), height=10, width=14, compress=TRUE)
nice_boxplot_list(L, title="Combinatorial correlation")
dev.off()
...
```{r include=FALSE, cache=FALSE}
  ...
  write.xlsx(result_transformed, "/Users/miyang/Documents/RWTH_Aachen/HELA/PLOT/combinatorial_correlation/combinatorial_pearson_correlation_TABLE.xlsx")
