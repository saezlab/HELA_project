...
load("~/Documents/RWTH_Aachen/RNAseq_GDSC_CCLE_genentech/RNAseq_GDSC_overlap.Rdata" )

tissue_label_gdsc_ID <- read.csv("~/Documents/RWTH_Aachen/SANGER_DATA/tissue_label_gdsc_ID", row.names=1)
...
```{r include=FALSE, cache=FALSE}
result_folder <- paste0("/Users/miyang/Documents/RWTH_Aachen/HELA/PLOT/PCA/") ; setwd(result_folder)
############################################# choose Omics layer !!! #############################################
...
```{r include=FALSE, cache=FALSE}
load("~/Documents/RWTH_Aachen/RNAseq_GDSC_CCLE_genentech/RPKM/GDSC_RPKM.Rdata" )
GDSC <- GDSC_RPKM   #  GDSC_RPKM   RNAseq_GDSC_overlap
GDSC[GDSC==0] <- 0.001
GDSC <- log10(GDSC)


result_folder <- paste0("/Users/miyang/Documents/RWTH_Aachen/HELA/PLOT/t_SNE/") ; setwd(result_folder)
############################################# choose Omics layer !!! #############################################
##  2:CNV, 3:mRNA, 4:Prot, 5:Kloss, 6:Let7, 7:ProtCopies
...
Fibro_Prot <- read.xlsx("/Users/miyang/Documents/RWTH_Aachen/HELA/ORIGINAL_DATA/FibroblastCells_Protein_Kloss_ForHelaMi.xlsx" ,1)
Fibro_Kloss <- read.xlsx("/Users/miyang/Documents/RWTH_Aachen/HELA/ORIGINAL_DATA/FibroblastCells_Protein_Kloss_ForHelaMi.xlsx",2)
