...
# area1=L[[1]];area2=L[[2]];area3=L[[3]];n12=L[[4]];n23=L[[5]];n13=L[[6]];n123=L[[7]]

#Add this: 
# areas[1] <- paste0(areas[1]," : ", round( 100*areas[1]/area1, 1), "%")
# areas[3] <- paste0(areas[3]," : ", round( 100*areas[3]/area2, 1), "%")
# areas[7] <- paste0(areas[7]," : ", round( 100*areas[7]/area3, 1), "%")

draw.triple.venn2 <- function (area1, area2, area3, n12, n23, n13, n123, category = rep("", 
...
#   
#   areas[1] <- paste0(areas[1]," : ", round( 100*as.numeric(areas[1])/area1, 1), "%")
#   areas[3] <- paste0(areas[3]," : ", round( 100*as.numeric(areas[3])/area2, 1), "%")
#   areas[7] <- paste0(areas[7]," : ", round( 100*as.numeric(areas[7])/area3, 1), "%")
  cell.labels <- areas 
