                     ...
                     tabItems(
                       tabItem(tabName = "Home",
                              h1("Welcome to the HeLa App"),
                               ...
                               p("Liu, Y. et al.", 
                                 tags$a("Genomic, Proteomic and Phenotypic Heterogeneity in HeLa Cells across Laboratories: Implications for Reproducibility of Research Results. (2018). doi:10.1101/307421",
